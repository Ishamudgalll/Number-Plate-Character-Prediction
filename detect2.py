# -*- coding: utf-8 -*-
"""
Created on Sun Oct 13 19:13:05 2019
...
car_denoised=filters.median(car_image , selem=np.ones((5,5)))
f,(ax0,ax1)=plt.subplots(1,2,figsize=(5,15))
ax0.imshow(car_image)
ax1.imshow(car_denoised)

fig, (ax1, ax2) = plt.subplots(1, 2)
ax1.imshow(car_denoised, cmap="gray")
#ax1.imshow(gray_car_image, cmap="gray")
#ax2.imshow(gray_car_image, cmap="gray")
#plt.hist(gray_car_image.ravel(),256,[0,256])
#plt.show()
#ax1.imshow(gray_car_image, cmap="gray")
threshold_value = threshold_otsu(car_denoised)
#threshold_value = threshold_otsu(gray_car_image)
#print(threshold_value)
#print(gray_car_image)
binary_car_image = car_denoised > threshold_value
print("binary")
...
edges=feature.canny(car_denoised,sigma=5).all()
plt.show(edges)
# this gets all the connected regions and groups them together
label_image = measure.label(binary_car_image)

print(label_image.shape[0]) #width of car img
print(label_image.shape[1])
